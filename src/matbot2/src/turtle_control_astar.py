...
from astar_planner import plan

#Define the method which contains the main functionality of the node.
def controller(waypoint_trans):
  """
...
def planning_callback(msg):
  try:
    trajectory = plan((msg.x, msg.y)) # TODO: What is the tuple input to this function?
    print("131")
