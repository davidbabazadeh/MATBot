...
class ObjectDetector:
    ...
    def pixel_to_point(self, u, v, depth):
        ...
        # X = np.cross(u - self.cx, depth) / self.fx
        # Y = np.cross(v - self.cy, depth) / self.fy
    ...
    def process_images(self):
        ...
        lower_hsv = np.array([64, 43, 47]) # TODO: Define lower HSV values for cup color
        upper_hsv = np.array([84, 255, 255]) # TODO: Define upper HSV values for cup color
